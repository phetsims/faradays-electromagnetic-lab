...
(5) Open in the browser: `http://localhost/faradays-electromagnetic-lab/faradays-electromagnetic-lab_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/faradays-electromagnetic-lab/build/adapted-from-phet/faradays-electromagnetic-lab_en_adapted-from-phet.html` (You will
