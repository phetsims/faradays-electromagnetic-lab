...
type SelfOptions = {
 //TODO add options that are specific to PickupCoilScreenView here
};

type PickupCoilScreenViewOptions = SelfOptions & ScreenViewOptions;

export default class PickupCoilScreenView extends ScreenView {

  public constructor( model: PickupCoilModel, providedOptions: PickupCoilScreenViewOptions ) {

    const options = optionize<PickupCoilScreenViewOptions, SelfOptions, ScreenViewOptions>()( {
